...
\begin{figure}[H]
\centering
\includegraphics[width = 10cm, height = 14cm]{example-image}
\label{fig:upload}
...
\begin{figure}[htp]
\centering
\includegraphics[width =10cm, height = 1cm]{example-image}
\caption{Navigation Bar Paper Creation}
\end{figure}
...
\begin{figure}[htp]
\centering
\includegraphics[width = 8cm, height = 11cm]{example-image}
